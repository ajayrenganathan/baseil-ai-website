      ...
      <SignIn
        ...
        appearance={{
          ...
          elements: {
            ...
            socialButtons: '[&_button]:!bg-[#243830] [&_button]:!border-[#2a3830] [&_button]:hover:!bg-[#2d4a3d] [&_button]:hover:!border-[#52B788]/40 [&_button]:!text-white [&_button_span]:!text-white',
            socialButtonsBlockButton: '!bg-[#243830] !border-[#2a3830] rounded-xl hover:!bg-[#2d4a3d] hover:!border-[#52B788]/40 transition-all duration-200 py-2.5',
            socialButtonsBlockButtonText: '!text-white font-medium text-sm',
            socialButtonsIconButton: '!bg-[#243830] !border-[#2a3830] rounded-xl hover:!bg-[#2d4a3d] hover:!border-[#52B788]/40 transition-all duration-200',
